module.exports = {
  "ryu": {
    favorable: ["E. Honda", "Sagat", "Rashid"],
    unfavorable: ["Kimberly", "Dhalsim", "Dee Jay"],
  ...
  "ken": {
    favorable: ["E. Honda", "Kimberly", "M. Bison"],
    unfavorable: ["Dhalsim", "Dee Jay", "Luke"],
  ...
  "chun-li": {
    favorable: ["Kimberly", "Luke", "Sagat"],
    unfavorable: ["E. Honda", "Dhalsim", "Dee Jay"],
    counter_strategy: "Contest her Stance entries with preemptive Drive Rushes or low attacks that go under her far medium buttons. Play for whiff punishes on her heavy normals. If cornered, use delayed tech. Do not wait for her to burn her Drive Gauge, instead, learn to interrupt her Serenity Stream stance transitions with fast 4-frame buttons or Perfect Parries to break her pressure loops."
  },
  "jamie": {
    favorable: ["M. Bison", "Rashid", "Elena"],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
  ...
  "luke": {
    favorable: ["Dee Jay", "Sagat", "M. Bison"],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
  ...
  "manon": {
    favorable: ["E. Honda", "Dee Jay", "Ingrid"],
    unfavorable: ["Kimberly", "Dhalsim", "Luke"],
  ...
  "kimberly": {
    favorable: ["Dhalsim", "Luke", "JP"],
    unfavorable: ["E. Honda", "Dee Jay", "Sagat"],
    counter_strategy: "React to her teleport setups and keep your anti-airs ready. Use Drive Impact to punish telegraphed run strings. Deny her safe jump setups with Perfect Parry attempts, then walk her to mid-screen where her hit-confirms are weaker."
  },
  "marisa": {
    favorable: ["E. Honda", "Dee Jay", "Luke"],
    unfavorable: ["Kimberly", "Dhalsim", "JP"],
  ...
  "lily": {
    favorable: ["Dee Jay", "M. Bison", "Elena"],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
  ...
  "dhalsim": {
    favorable: ["Luke", "JP", "Sagat"],
    unfavorable: ["E. Honda", "Kimberly", "Dee Jay"],
  ...
  "dee-jay": {
    favorable: ["Kimberly", "Dhalsim", "Sagat"],
    unfavorable: ["E. Honda", "Luke", "JP"],
  ...
  "e-honda": {
    favorable: ["Kimberly", "Dhalsim", "Dee Jay"],
    unfavorable: ["Marisa", "Ken", "Manon"],
  ...
  "blanka": {
    favorable: ["Kimberly", "Dhalsim", "JP"],
    unfavorable: ["E. Honda", "Dee Jay", "Luke"],
  ...
  "juri": {
    favorable: ["JP", "M. Bison", "A.K.I."],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
    counter_strategy: "Do not allow free Fuha stores. Contest at the maximum range of her medium buttons and force her to burn Drive Gauge with tight pressure. Without stocks, her screen control falls and her offensive approach becomes much more linear."
  },
  "cammy": {
    favorable: ["Dhalsim", "Ingrid", "Rashid"],
    unfavorable: ["E. Honda", "Kimberly", "Dee Jay"],
  ...
  "aki": {
    favorable: ["Dhalsim", "Dee Jay", "JP"],
    unfavorable: ["E. Honda", "Kimberly", "Luke"],
    counter_strategy: "Parry projectiles to avoid poison application, or land a hit to cleanse the status immediately. Challenge her retreat with long-range buttons. On knockdown, her limited invincible OD reversal options make any okizeme sequence decisive."
  },
  "rashid": {
    favorable: ["Kimberly", "Dhalsim", "JP"],
    unfavorable: ["E. Honda", "Dee Jay", "Luke"],
  ...
  "mai": {
    favorable: ["Dee Jay", "Luke", "C. Viper"],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
  ...
  "sagat": {
    favorable: ["Kimberly", "Ingrid", "M. Bison"],
    unfavorable: ["E. Honda", "Dhalsim", "Dee Jay"],
  ...
  "terry": {
    favorable: ["Kimberly", "Dhalsim", "Ingrid"],
    unfavorable: ["E. Honda", "Dee Jay", "Luke"],
  ...
  "elena": {
    favorable: ["Luke", "Ingrid", "Guile"],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
    counter_strategy: "Walk into her range to bait pokes, then catch her extended limb recovery with a buffered Drive Rush. Corner her and run tight meaties. Her defensive options are highly susceptible to throw/shimmy loops, forcing her to guess or spend Super meter to escape."
  },
  "zangief": {
    favorable: ["E. Honda", "Kimberly", "Dee Jay"],
    unfavorable: ["Dhalsim", "Luke", "JP"],
  ...
  "c-viper": {
    favorable: ["Ingrid", "M. Bison", "Blanka"],
    unfavorable: ["E. Honda", "Kimberly", "Dhalsim"],
    counter_strategy: "Cut off Burn Kick lanes with early anti-airs and preemptive crouching heavy punches. Interrupt Seismo chains with forward-advancing Drive Rushes when she overextends. On her wakeup, run layered okizeme since her defensive options are highly susceptible to throw/shimmy loops."
  },
  "alex": {
    favorable: ["Dhalsim", "JP", "Sagat"],
    unfavorable: ["E. Honda", "Kimberly", "Dee Jay"],
    counter_strategy: "Check Prowler Stance transitions with fast pokes since he cannot block. Avoid predictable projectiles to deny his armored lariat and Level 2 Super. After a heavy Flash Chop, anticipate the Power Bomb. Pressure his wakeup, as his only invincible reversal costs Super meter."
  },
  "ingrid": {
    favorable: ["Dhalsim", "Luke", "JP"],
    unfavorable: ["E. Honda", "Kimberly", "Dee Jay"],
    counter_strategy: "Play patiently and avoid throwing predictable projectiles that she can reflect with Sunburst. Wait for her unorthodox floating approaches and punish them with reliable anti-airs. Because she struggles to force entry and has below-average health, let her take the risks. Once you secure a knockdown, utilize throw setups and shimmy pressure to bypass her parries and quickly deplete her health bar."
  },
  "yasmine": {
    favorable: ["Zangief", "E. Honda", "Lily"],
    unfavorable: ["Guile", "JP", "Dhalsim"],
    counter_strategy: "Hold your ground in neutral and force her to approach without a Bayani Mode trigger active, since her follow-up attacks are weaker before Alon or Talim ng Hangin connects. Anti-air her Mukha ng Langit jump-in on reaction. If she throws out Pangil sa Likuran, punish it hard on whiff, as the boomerang disappears entirely if she gets hit while it's active. On knockdown, respect only the Overdrive version of Lipad ng Agila as a real invincible threat; without meter, she has no invincible reversal to escape tight okizeme."
  },
  "default": {
    favorable: ["N/A"],
    unfavorable: ["N/A"],
    counter_strategy: "Matchup data is not yet available for this character."
  }
}
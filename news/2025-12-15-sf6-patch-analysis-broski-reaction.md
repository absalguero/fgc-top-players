---
title: "SF6 Patch Analysis: Broski & Pros React to \"Safe\" Update"
layout: article.njk
...
<div class="table-wrapper m-auto max-w-90ch" style="margin-bottom: 40px; overflow-x: auto;">
  <table class="data-table" style="min-width: 100%;">
    <thead>
      <tr>
        <th>Character</th>
        <th>Tech Discovery</th>
        <th>Competitive Impact</th>
      </tr>
    </thead>
    <tbody>
      <tr><td><strong>Elena</strong></td><td>Level 1 Super (7f Startup)</td><td>New long-range punish for -7 moves where mediums would whiff.</td></tr>
      <tr><td><strong>Sagat</strong></td><td>Crouch MK (+5 on Hit)</td><td>Enables <strong>cr.MK > st.LP</strong> link, improving consistency.</td></tr>
      <tr><td><strong>Mai</strong></td><td>Forward Throw Spacing</td><td>Disables "auto-pilot" shimmy, forcing hard reads in the corner.</td></tr>
      <tr><td><strong>Sagat</strong></td><td>Tiger Monolith (3f Active)</td><td>Removes the "dead zone" frame that caused anti-airs to drop.</td></tr>
    </tbody>
  </table>
</div>
...
*Source: [Broski](https://www.youtube.com/watch?v=qY-XnTkXEHc)*

<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin: 20px auto;">
  <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://www.youtube.com/embed/qY-XnTkXEHc" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>